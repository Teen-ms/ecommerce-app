...
function Footer() {
  ...
  <div className="footer-container">
    <div className="footer-col" role="navigation" aria-labelledby="quick-nav-heading" itemscope itemtype="http://schema.org/SiteNavigationElement">
    ...
    <div className="footer-col" role="navigation" aria-labelledby="contents-heading">
    ...
    <div className="footer-col" role="navigation" aria-labelledby="resources-heading">
